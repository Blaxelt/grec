...
FAKE_RECOMMENDATIONS = [
    GameRecommendation(id=1, game_name="Dark Souls 1", header_image="https://example.com/img1.jpg", similarity=0.9, wilson_score=0.8, hybrid_score=0.72),
    GameRecommendation(id=2, game_name="Dark Souls 2", header_image="https://example.com/img2.jpg", similarity=0.8, wilson_score=0.7, hybrid_score=0.56),
]
